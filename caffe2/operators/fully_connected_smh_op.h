...
#ifndef CAFFE2_OPERATORS_FULLY_CONNECTED_SMH_OP_H_
#define CAFFE2_OPERATORS_FULLY_CONNECTED_SMH_OP_H_
...
class FullyConnectedSmhOp final : public Operator<Context> {
 public:
  USE_OPERATOR_CONTEXT_FUNCTIONS;
  FullyConnectedSmhOp(const OperatorDef& operator_def, Workspace* ws)
...
template <class Context, class Engine = DefaultEngine>
class FullyConnectedSmhGradientOp : public Operator<Context> {
 public:
  USE_OPERATOR_CONTEXT_FUNCTIONS;
  FullyConnectedSmhGradientOp(const OperatorDef& operator_def, Workspace* ws)
      : Operator<Context>(operator_def, ws),
        axis_(OperatorBase::GetSingleArgument<int32_t>("axis", 1)),
        axis_w_(OperatorBase::GetSingleArgument<int32_t>("axis_w", 1)) {}
  ~FullyConnectedSmhGradientOp() {}
...
#endif // CAFFE2_OPERATORS_FULLY_CONNECTED_SMH_OP_H_
